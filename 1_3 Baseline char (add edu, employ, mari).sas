...
PROC TABULATE DATA=R2_BL_MIAMI  MISSING;
BY REDCAP_DATA_ACCESS_GROUP;
CLASS REDCAP_DATA_ACCESS_GROUP  sdem_oat RAND_ARM
      SDEM_SEX AGE_CAT dem_race sdem_lang_mia_2 dem_race_hisp;
KEYLABEL COLPCTN='%' ;
TABLE  (SDEM_SEX AGE_CAT sdem_lang_mia_2 dem_race_hisp RAND_ARM)*(N /*COLPCTN*/)
,(REDCAP_DATA_ACCESS_GROUP*sdem_oat)
;
RUN;
